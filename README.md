...
- `brainstorming`, a folder to store research ideas, peer feedback, etc. Contains:
  * `_template_research_project.Rmd`, a template (in Rmarkdown format) to organize and structure the first ideas about the project (draft version).
  * `_template_research_project.pdf`, the research project pdf file generated by `_template_research_project.Rmd`.
