...
* Select [use this template](https://github.com/jpgmv1998/reproducible_paper_template/generate) (upper right corner) and follow the instructions to create your own GitHub repository
